              ...
              <div className="inline-slide">
                <div className="slide-inner" style={{ textAlign: "center" }}>
                  ...
                  <div className="wn-grid">
                    <div className="wn-card hl"><div className="wn-new">New</div><div className="wn-icon">🪑</div><div className="wn-name">Visual Floor Plan</div><div className="wn-desc">Drag-and-drop table layout matching your real venue — square, round, rectangular or bar/counter seating, freely sized. Live status per table: free, upcoming, confirmed, seated.</div></div>
                    <div className="wn-card hl"><div className="wn-new">New</div><div className="wn-icon">📸</div><div className="wn-name">Recipe Photos</div><div className="wn-desc">Upload a photo of the finished dish to every recipe so kitchen staff always know exactly how a plate should look before it goes out.</div></div>
                    <div className="wn-card hl"><div className="wn-new">New</div><div className="wn-icon">⏰</div><div className="wn-name">HACCP Reminder Schedules</div><div className="wn-desc">Set custom reminder times per check type. Notifies whoever's clocked in or on rota, and keeps reminding until the check is logged.</div></div>
                    ...
                    <div className="wn-card"><div className="wn-icon">📣</div><div className="wn-name">AI Outreach Engine</div><div className="wn-desc">Researches leads, writes personalised emails and runs daily campaigns automatically — the same engine that grew Rotahr itself.</div></div>
                    <div className="wn-card"><div className="wn-icon">📰</div><div className="wn-name">SEO Content Blog</div><div className="wn-desc">AI publishes a fresh hospitality article daily — employment law, scheduling tips, cost control — built to bring in organic traffic.</div></div>
