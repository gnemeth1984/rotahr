...
const pricingFaq = [
  ...
  },
  {
    ...
    a: "The first month is free on Starter and Pro, with no card needed to start. There is no free forever tier. If you only want the free parts, the template library at /templates is completely ungated: no email address, no sign-up.",
  },
  {
